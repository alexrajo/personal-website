  ...
  return (
    <PageWrapper currentPage='about'>
      <div className='lg:px-40 xl:px-64 2xl:px-96'>
        <h1>About me</h1>
        <p>
          I am Alexander, a 21 year old student from Norway. I am currently studying for a M. Sc. in Computer Science at
          NTNU in Trondheim, Norway. My interests involve game development and web development.
        </p>
        <div className='xs:mt-10 sm:mt-20'>
          <h2>Main technologies & languages</h2>
          <br />
          <div className='grid xs:grid-cols-3 sm:grid-cols-4 md:grid-cols-5 xl:grid-cols-7 gap-5'>
            ...
            <TechDisplay name='Python' imageUrl='/images/python-logo.svg' />
            <TechDisplay name='Lua' imageUrl='/images/lua-logo.svg' />

            <TechDisplay name='React' imageUrl='/images/react-icon.svg' />
            <TechDisplay name='PostgreSQL' imageUrl='/images/postgresql-logo.svg' />
            <TechDisplay name='NodeJS' imageUrl='/images/nodejs-icon.svg' />
            <TechDisplay name='Supabase' imageUrl='/images/supabase-logo.png' />
            ...
            <TechDisplay name='GraphQL' imageUrl='/images/graphql-logo.svg' />
          </div>
        </div>
      </div>
    </PageWrapper>
